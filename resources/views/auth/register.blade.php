    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                ...
                <x-jet-input id="direccion" class="block mt-1 w-full" type="direccion" name="direccion" :value="old('direccion')" required/>
            </div>

            <div class="mt-4">
                <x-jet-label for="numero" value="{{ __('Numero') }}" />
                <x-jet-input id="numero" class="block mt-1 w-full" type="numero" name="numero" :value="old('numero')" required />
            </div>
